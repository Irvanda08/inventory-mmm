                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="bg-slate-50 border-b border-slate-100">
                            ...
                            <th class="px-6 py-4 text-xs font-bold text-slate-500 uppercase">Kode</th>
                            <th class="px-6 py-4 text-xs font-bold text-slate-500 uppercase">Nama Produk</th>
                    ...
                    <tbody class="divide-y divide-slate-100">
                        ...
                        <tr class="hover:bg-slate-50/50 transition-colors">
                          ...
                          <td class="px-6 py-4">
                              <span class="text-[10px] font-mono font-bold text-blue-600 bg-blue-50 px-1.5 py-0.5 rounded w-fit uppercase"><?= htmlspecialchars($row['kode_barang']) ?></span>
                          </td>
                          <td class="px-6 py-4">
...
<style>
@media print {
    .no-print, #sidebar, nav, header, footer, button, .logout-section, form { 
